...
public class DriverRunner {
    ...
    public static AndroidDriver createDriver() throws MalformedURLException{
        ...
        String appPath = "Documents/GitHub/mbt-study/src/main/resources/fossify_file-manager_v1-3-1.apk";
        String appPackage = "org.fossify.filemanager";
        String appActivity1 = "org.fossify.filemanager.activities.MainActivity";
