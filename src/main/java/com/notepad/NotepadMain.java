...
import com.notepad.impl.NotepadTestImpl;

public class NotepadMain {

    public static void executeNotepadTests() throws IOException {

        System.out.println("=".repeat(50));
        System.out.println(" Iniciando testes do Notepad ");
        System.out.println("=".repeat(50));
        ...
        // Executa os testes
        Executor executor = new TestExecutor(NotepadTestImpl.class);
